<template>
    <el-card>
        <el-table border :data="skuArr">
            ...
            <el-table-column label="描述" show-overflow-tooltip width="400x" prop="skuDesc"></el-table-column>
            <el-table-column label="图片" width="150px">
                <template #="{ row, $index }">
                    <img :src="row.skuDefaultImg" alt="" style="width: 100px;height: 100px;"></template>
            </el-table-column>
            ...
            <el-table-column label="操作" width="250px" fixed="right">
                <template #="{ row, $index }">
                    ...
                    <el-popconfirm title="确定要删除当前数据?`" width="200px" @confirm="removeSku(row.id)">
                        <template #reference>
